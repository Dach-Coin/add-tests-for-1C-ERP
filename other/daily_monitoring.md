...
3. Общие параметры для всех счетчиков:
    ...
    Памятка по назначению стандартных счетчиков, поставляемых MS SQL: <https://blog.it-kb.ru/2022/03/23/windows-performance-monitor-perfmon-counters-for-sql-server-diagnostics/>
...
5. Настраиваем на серверах СУБД сеансы отслеживания расширенных событий (extended events)
    ...
    Перед созданием самих сессий нужно убедиться, что каталог для хранения файлов трассировок заранее создан и на него выданы права на чтение/запись пользователю, из под которого запущена служба sql-сервера.
...
7. Инспектируем сервера 1С и СУБД на предмет "детских" ошибок:
    ...
    - проверка на "лицензионную чистоту": https://1c.ru/rus/support/surrog.htm?utm_source=its_ru&utm_medium=news&utm_campaign=antipiracy и https://infostart.ru/1c/articles/1119217/
